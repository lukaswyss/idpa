export const DEFAULT_CHALLENGE_CONFIG: any = {
  ...
  daily: {
    questions: [
      ...
      { id: "d_bike", label: "Fahrrad statt Auto genutzt", type: "boolean", weight: 2, category: "Public" },
  ...
  defined: {
    weekly: {
      ...
      questions: [
        ...
        //Arbeit
        { id: "def_work_promo", label: "Auszeichnung oder Beförderung am Arbeitsplatz", type: "boolean", weight: 4, category: "Work" },
        ...
        //Negative
        //Public
        { id: "def_negative_accident", label: "Verkehrsunfall zu verschulden", type: "boolean", weight: -10, category: "Public" },
        { id: "def_negative_noise", label: "Lärmbelästigung in der Öffentlichkeit", type: "boolean", weight: -2, category: "Public" },
        { id: "def_negative_alcohol", label: "Alkohol/Glasflaschen im verbotenen Bereich konsumieren", type: "boolean", weight: -2, category: "Public" },

        //Work
        { id: "def_negative_work_missdeadline", label: "Projektabgabe verpasst", type: "boolean", weight: -2, category: "Work" },

        //Private
        { id: "def_negative_private_noise", label: "Ruhestörung durch laute Musik oder feiern", type: "boolean", weight: -3, category: "Private" },
        { id: "def_negative_private_dunning", label: "Eine Mahnung bekommen", type: "boolean", weight: -3, category: "Private" },
        { id: "def_negative_private_complaint", label: "Nachbarschaftsbeschwerde (z. B. Lärm)", type: "boolean", weight: -2, category: "Private" },

        // Digital
        { id: "def_digital_kind", label: "Sich Online freundlich/konstruktiv äussern", type: "boolean", weight: 1, category: "Digital" },
        { id: "def_digital_report", label: "Fake-News gemeldet", type: "boolean", weight: 2, category: "Digital" },
        { id: "def_digital_security", label: "Eigene Daten sicher verwalten (z.B anhand von 2FA)", type: "boolean", weight: 2, category: "Digital" },
