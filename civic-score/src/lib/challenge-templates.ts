export const DEFAULT_CHALLENGE_CONFIG: any = {
  ...
  daily: {
    questions: [
      ...
      { id: "d_elderly", label: "Älteren/Menschen mit Handicap im ÖV Platz angeboten", type: "boolean",weight: 2},
      // Work
      ...
      { id: "d_work_colleague", label: "Kolleg:in aktiv unterstützt", type: "boolean",weight: 2},
      // Private
      ...
      { id: "d_digital_share", label: "Hilfreiche Inhalte geteilt (z. B. Tutorial, Sicherheitshinweise)", type: "boolean",weight: 1},
      { id: "d_digital_mobbing", label: "Mobbing gemeldet", type: "boolean",weight: 2},
      
      
      // Negative
      //Public
      { id: "d_negative_fare", label: " Öffentlicher Verkehr ohne Ticket", type: "boolean",weight: -3},
      { id: "d_negative_littering", label: "Littering", type: "boolean",weight: -2},
      { id: "d_negative_risk", label: "Öffentliches Risiko geschaffen (z. B. Fahrrad ohne Licht, Hund ohne Leine)", type: "boolean",weight: -3},
      { id: "d_negative_speed", label: "Geschwidikeit überschritten", type: "boolean",weight: -3},
      { id: "d_negative_cross", label: "Strasse überqueren ohne fussgänger zu nutzen", type: "boolean",weight: -1},
      { id: "d_negative_accident", label: "Verkehrsunfall zu verschulden", type: "boolean",weight: -10},
      { id: "d_negative_park", label: "Parken im Halteverbot / Parkverbot", type: "boolean",weight: -3},
      { id: "d_negative_litter", label: "Falschentsorgung von Müll (z.B Dosen im Karton)", type: "boolean",weight: -2},
      { id: "d_negative_noise", label: "Lärmbelästigung in der Öffentlichkeit", type: "boolean",weight: -2},
      { id: "d_negative_alcohol", label: "Alkohol/Glasflaschen im verbotenen Bereich konsumieren", type: "boolean",weight: -2},

      // Work
      { id: "d_negative_work_noshow", label: "Unentschuldigtes Fehlen", type: "boolean",weight: -3},
      { id: "d_negative_work_missdeadline", label: "Projektabgabe verpasst", type: "boolean",weight: -2},
      { id: "d_negative_work_unproductive", label: "Absichtlich unproduktives Verhalten (z.B Bei der Arbeit Tiktok schauen)", type: "boolean",weight: -2},  
      { id: "d_negative_conflict", label: "Konflikt am Arbeitsplatz eskalieren lassen", type: "boolean",weight: -2},

      // Private
      { id: "d_negative_private_apptmissed", label: "Termin verpassen", type: "boolean",weight: -1},
      ...
      { id: "d_negative_digital_misinfo", label: "Fake-News geteilt", type: "boolean",weight: -3},
      { id: "d_negative_digital_mobbing", label: "Cybermobbing/Beleidigungen", type: "boolean",weight: -4},
      { id: "d_negative_digital_piracy", label: "Illegale Downloads/Streaming", type: "boolean",weight: -2},
      { id: "d_negative_digital_identity", label: "Falsche Identität im Netz verwentet", type: "boolean",weight: -3},
      { id: "d_negative_digital_data", label: "Private Daten anderer veröffentlicht", type: "boolean",weight: -5},
